const gasModalBtn = document.getElementById("gas-button");
...
gasForm.addEventListener("click", function (event) {
    ...
    const consumptionInput = document.getElementById("mr-consumption").value;
    ...
    const unitsTotal = consumptionInput * (unitRate + carbonTaxRate)
    ...
    <div class="results-groups">
      ...
      <div class="results-card">
        ...
        <div class="results-section">
          ...
          <div class="results-row"><span class="results-label">Units used</span><span class="results-value">${consumptionInput}</span></div>
        </div>
    ...
    <div class="script-grid">
        ...
        <summary>
            <span>Units</span>
            <span class="script-meta">${consumptionInput} units over ${daysDifference} days</span>
        </summary>
        <div class="script-body">
            <p>
            So, we're doing a read for ${daysDifference} days, in that time you used a total of
            ${consumptionInput} Kilowatt Hours, or "units".
            ...
            <strong>Quick summary:</strong> ${consumptionInput} units, ${money(unitsTotal)} total unit costs.
            </div>
        </div>
        </details>
    ...
    <div class="link-card">
        ...
        <a class="link-action" target="_blank" rel="noopener noreferrer"
